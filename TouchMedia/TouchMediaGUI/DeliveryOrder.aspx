                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="العمليات">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="btnPrintDel" runat="server" CommandArgument='<%# Eval ("DeliveryOrderID") %>' CommandName="PrintDO">طباعة</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="block-margin-bottom-5 span12 clearfix">
                            <div class="span6">
                                ...
                                <asp:DropDownList runat="server" type="text" ID="drpClientName" />
