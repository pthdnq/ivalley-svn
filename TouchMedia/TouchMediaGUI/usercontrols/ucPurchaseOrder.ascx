<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPurchaseOrder.ascx.cs" Inherits="TouchMediaGUI.ucPurchaseOrder" %>
            ...
            <div class="span12">
                <div class="form-horizontal">
                    ...
                    <div class="block-margin-bottom-5 span12 clearfix" style="margin-right: 0">
                        ...
                        <div class="span6">
                            <asp:LinkButton runat="server" ID="btnPurSearch" Width="70px" OnClick="btnPurSearch_Click" class="btn btn-success"> بحث   <i class="icon-search icon-white" ></i></asp:LinkButton>
                        </div>
                    </div>
                    <div class="span12">
                        <hr />
