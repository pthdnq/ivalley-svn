    ...
    switch (culture) {
            ...
            localization =
        {
            ...
            days: {
                ...
                // abbreviated day names
                namesAbbr: ["د", "ن", "ث", "ع", "خ", "ج", "س"],
                // shortest day names
                namesShort: ["د", "ن", "ث", "ع", "خ", "ج", "س"]
            },
            months: {
                // full month names (13 months for lunar calendards -- 13th month should be "" if not lunar)
                names: ["يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر", ""],
                // abbreviated month names
                namesAbbr: ["يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر", ""]
            },
            // AM and PM designators in one of these forms:
            // The usual view, and the upper and lower case versions
            //      [standard,lowercase,uppercase]
        ...
        { "name": "A.D.", "start": null, "offset": 0 }
            ...
            decimalseparator: '.',
            thousandsseparator: ',',
            pagergotopagestring: "إذهب إلى الصفحة :",
            pagershowrowsstring: "عرض سجلات :",
            pagerrangestring: " من ",
            pagerpreviousbuttonstring: "السابق",
            pagernextbuttonstring: "التالى",
            pagerfirstbuttonstring: "الأول",
            pagerlastbuttonstring: "الأخير",
            ...
            groupbystring: "Group By this column",
            groupremovestring: "Remove from groups",
            filterclearstring: "إخلاء",
            filterstring: "تصفية",
            filtershowrowstring: "Show rows where:",
            filterorconditionstring: "أو",
            filterandconditionstring: "و",
            filterselectallstring: "(إختيار الكل)",
            filterchoosestring: "إختر:",
            ...
            validationstring: "القيمة التى تم إدخالها غير متاحة",
            emptydatastring: "لا يوجد بيانات",
