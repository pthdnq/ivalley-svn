                            ...
                            <div class="tabbable tabbable-custom" id="myTab">
                                <ul class="nav nav-tabs">
                                    <li runat="server" id="tab_MainData" class="active"><a href="#tab_1_1" data-toggle="tab">
                                        <asp:Label runat="server" ID="lblMainDataTab" Text="Main Data" ForeColor="Brown"
                                            Font-Bold="true"></asp:Label>
                                    </a></li>
                                    <li runat="server" id="tab_Generics"><a href="#tab_1_2" data-toggle="tab">
                                        <asp:Label runat="server" ID="lblGenericTab" Text="Generic information" ForeColor="DarkGreen"
                                            Font-Bold="true"></asp:Label>
                                    </a></li>
                                    <li runat="server" id="tab_Status"><a href="#tab_1_3" data-toggle="tab">
                                        <asp:Label runat="server" ID="lblStatusTab" Text="Status History" ForeColor="DarkGoldenrod"
                                            Font-Bold="true"></asp:Label>
                                    </a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane" id="tab_1_3">
                                        <div class="span9">
                                            ...
                                            <div class="widget">
                                                <div class="widget-title">
                                                    <h4>
                                                        <i class="icon-cogs"></i>Full Status History</h4>
                                        ...
                                        <div class="span3">
                                            <div class="widget">
                                                <div class="widget-title">
                                                    <h4>
                                                        <i class="icon-plus"></i>Add New Status</h4>
                                                    <span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;"
                                                        class="icon-remove"></a></span>
                                                </div>
