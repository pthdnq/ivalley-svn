...
{
	public abstract class _PackageStatusHistory : SqlClientEntity
	{
		public _PackageStatusHistory()
		{
			this.QuerySource = "PackageStatusHistory";
			this.MappingName = "PackageStatusHistory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PackageStatusHistoryLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int StatusHistoryID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PackageStatusHistoryLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter StatusHolder
			{
				get
				{
					return new SqlParameter("@StatusHolder", SqlDbType.NVarChar, 300);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[StatusHistoryID] = _PackageStatusHistory.PropertyNames.StatusHistoryID;
					ht[TradePricingID] = _PackageStatusHistory.PropertyNames.TradePricingID;
					ht[PackageDetailID] = _PackageStatusHistory.PropertyNames.PackageDetailID;
					ht[CommitteeTypeID] = _PackageStatusHistory.PropertyNames.CommitteeTypeID;
					ht[CommitteeDescisionID] = _PackageStatusHistory.PropertyNames.CommitteeDescisionID;
					ht[CompanyDescisionID] = _PackageStatusHistory.PropertyNames.CompanyDescisionID;
					ht[PricingStatusID] = _PackageStatusHistory.PropertyNames.PricingStatusID;
					ht[CommitteDate] = _PackageStatusHistory.PropertyNames.CommitteDate;
					ht[CurrentPrice] = _PackageStatusHistory.PropertyNames.CurrentPrice;
					ht[Comment] = _PackageStatusHistory.PropertyNames.Comment;
					ht[AttachementPath] = _PackageStatusHistory.PropertyNames.AttachementPath;
					ht[StatusDate] = _PackageStatusHistory.PropertyNames.StatusDate;
					ht[StatusHolder] = _PackageStatusHistory.PropertyNames.StatusHolder;
					ht[PackID] = _PackageStatusHistory.PropertyNames.PackID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[StatusHistoryID] = _PackageStatusHistory.ColumnNames.StatusHistoryID;
					ht[TradePricingID] = _PackageStatusHistory.ColumnNames.TradePricingID;
					ht[PackageDetailID] = _PackageStatusHistory.ColumnNames.PackageDetailID;
					ht[CommitteeTypeID] = _PackageStatusHistory.ColumnNames.CommitteeTypeID;
					ht[CommitteeDescisionID] = _PackageStatusHistory.ColumnNames.CommitteeDescisionID;
					ht[CompanyDescisionID] = _PackageStatusHistory.ColumnNames.CompanyDescisionID;
					ht[PricingStatusID] = _PackageStatusHistory.ColumnNames.PricingStatusID;
					ht[CommitteDate] = _PackageStatusHistory.ColumnNames.CommitteDate;
					ht[CurrentPrice] = _PackageStatusHistory.ColumnNames.CurrentPrice;
					ht[Comment] = _PackageStatusHistory.ColumnNames.Comment;
					ht[AttachementPath] = _PackageStatusHistory.ColumnNames.AttachementPath;
					ht[StatusDate] = _PackageStatusHistory.ColumnNames.StatusDate;
					ht[StatusHolder] = _PackageStatusHistory.ColumnNames.StatusHolder;
					ht[PackID] = _PackageStatusHistory.ColumnNames.PackID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PackageStatusHistoryInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PackageStatusHistoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PackageStatusHistoryDelete]";
