<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ExceptionLight.Master" AutoEventWireup="true" CodeBehind="blogManagement.aspx.cs" Inherits="Flights_GUI.Admin.blogManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="uiPanelViewAll" runat="server">
        <div class="cell-2 clearfix pull-right">
            <asp:LinkButton ID="uiLinkButtonAdd" runat="server" CssClass="btn btn-primary" OnClick="uiLinkButtonAdd_Click">Add new blog</asp:LinkButton>
    ...
    <asp:Panel ID="uiPanelEdit" runat="server">
        ...
        <div class="cell-12 clearfix">
            ...
            <div class="cell-4">
                <asp:TextBox ID="uiTextBoxBrief" runat="server" TextMode="MultiLine" Rows="4" Columns="20"></asp:TextBox>
            </div>
        </div>
        <div style="clear: both; height: 5px;"></div>
        <div class="cell-12 clearfix">
