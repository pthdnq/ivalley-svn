<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ExceptionLight.Master" AutoEventWireup="true" CodeBehind="circularsManagment.aspx.cs" Inherits="Flights_GUI.Admin.circularsManagment" %>
...
<%--                <asp:DropDownList ID="DropDownListGroups" runat="server"></asp:DropDownList>--%>
        ...
        <div class="cell-12 clearfix" style="margin-left: 0">
            ...
            <div class="cell-10">
                <iframe src="../uiUpload.html" style="border: 0; width: 80%; overflow: hidden; height: 150px;"></iframe>
            </div>
        </div>
        <div style="clear: both; height: 5px;"></div>
        <div class="cell-12 clearfix" style="margin-left: 0;">
