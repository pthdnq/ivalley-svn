<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ExceptionLight.Master" AutoEventWireup="true" CodeBehind="Bulletins.aspx.cs" Inherits="Flights_GUI.Intranet.Bulletins" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel runat="server" ID="uiPanelViewAll">
        <%-- <div id="tabs" class="tabs">
            <ul>
                <li class="active"><a href="#"><i class="fa fa-globe"></i>Public Bulletins</a></li>
                                    ...
                                    <img src='<%# (string.IsNullOrEmpty(Eval("MainPic").ToString()) ? "../img/flyegypt.png" : "../common/thumb.aspx?Image=" + Eval("MainPic")) %>' alt="" style="max-height: 177px; max-width: 300px; width: 300px; margin: 0 auto 10px; display: block">
                                        ...
                                        <article class="post-content">
                                            <div class="post-info-container">
                                                <div class="post-info">
                                                    <h2><a class="main-color" href='Bulletins.aspx?cid=<%# Eval("AnnouncementID") %>'><%# Eval("Code").ToString() + " " + Eval("Title").ToString() %></a></h2>
                                                    <ul class="post-meta">
