...
{
	public abstract class _IssueType : SqlClientEntity
	{
		public _IssueType()
		{
			this.QuerySource = "IssueType";
			this.MappingName = "IssueType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_IssueTypeLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int IssueTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.IssueTypeID, IssueTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_IssueTypeLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[IssueTypeID] = _IssueType.PropertyNames.IssueTypeID;
					ht[Name] = _IssueType.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[IssueTypeID] = _IssueType.ColumnNames.IssueTypeID;
					ht[Name] = _IssueType.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_IssueTypeInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.IssueTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_IssueTypeUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_IssueTypeDelete]";
