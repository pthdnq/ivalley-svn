                    ...
                    <MasterTableView>
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("ScheduleID") %>' Visible='<%# (Membership.GetUser().ProviderUserKey.ToString() == Eval("CreatedBy").ToString()) %>'
                                    ...
                                    &nbsp;
                                    <a href='/BI/reporting.aspx?t=s&sid=<%# Eval("ScheduleID") %>'><img src="../images/bar_chart1.png" alt="View report" title="View report" style="border:0;float:none;max-width:24px;" /></a>
                                </ItemTemplate>
            ...
            <telerik:RadGrid ID="uiRadGridVersions" runat="server" AllowPaging="True"
                ...
                <MasterTableView>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Actions">
                            <ItemTemplate>                                
                                <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("ScheduleVersionID") %>' Visible='<%# (Membership.GetUser().ProviderUserKey.ToString() == Eval("CreatedBy").ToString()) %>'
                                ...
                                &nbsp;
                                    <a href='/BI/reporting.aspx?t=s&svid=<%# Eval("ScheduleVersionID") %>'><img src="../images/bar_chart1.png" alt="View report" title="View report" style="border:0;float:none;max-width:24px;" /></a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
                </MasterTableView>
