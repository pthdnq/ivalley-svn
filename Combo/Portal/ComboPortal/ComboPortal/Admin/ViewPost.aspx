                        ...
                        <asp:Repeater ID="RepeaterComments" OnItemCommand="RepeaterComments_ItemCommand" OnItemDataBound="RepeaterComments_ItemDataBound" runat="server">
                            <ItemTemplate>
                                <div class="span12" style="margin-right: 0px">
                                    <ul class="chats normal-chat">
                                        <li class="in">
                                            <img class="avatar" id="imgUserProfile" runat="server" alt="" src='<%# string.IsNullOrWhiteSpace(Eval("ProfilePic").ToString())? "img/profile-pic2.png" : "http://api.combomobile.com" +  Eval("ProfilePic") %>' />
                                            <div class="message">
                                                <span class="arrow"></span>
