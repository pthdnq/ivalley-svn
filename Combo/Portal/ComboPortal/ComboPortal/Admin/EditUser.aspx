                        ...
                        <ItemTemplate>
                            <div class="span10" style="margin-right: 0px">
                                <ul class="chats normal-chat">
                                    <li class="in">
                                        <img class="avatar" alt="" src='<%# string.IsNullOrWhiteSpace(Eval("ProfilePic").ToString())? "img/profile-pic2.png" : "http://api.combomobile.com" + Eval("ProfilePic") %>' />
                                        <div class="message ">
                                            ...
                                            <span class="body">
                                                ...
                                                <asp:Panel ID="PanelAttachment" Visible="false" runat="server">
                                                    ...
                                                    <audio id="audioAttachment" runat="server" visible="false" src="#" controls="controls"/>
                                                    <video id="videoAttachment" runat="server" style="max-height:200px" visible="false" src="#" controls="controls"/>
                                                </asp:Panel>
                                            </span>
                                        </div>
                                    </li>
