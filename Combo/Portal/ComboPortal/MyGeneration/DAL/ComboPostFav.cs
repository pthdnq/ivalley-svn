...
namespace COMBO_DAL
{
	public abstract class _ComboPostFav : SqlClientEntity
	{
		public _ComboPostFav()
		{
			this.QuerySource = "ComboPostFav";
			this.MappingName = "ComboPostFav";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ComboPostFavLoadAll]", parameters);
		}
...
parameters.Add(Parameters.ComboPostID, ComboPostID);
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ComboPostFavLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ComboUserID] = _ComboPostFav.PropertyNames.ComboUserID;
					ht[ComboPostID] = _ComboPostFav.PropertyNames.ComboPostID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ComboUserID] = _ComboPostFav.ColumnNames.ComboUserID;
					ht[ComboPostID] = _ComboPostFav.ColumnNames.ComboPostID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ComboPostFavInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ComboPostFavUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ComboPostFavDelete]";
